      ...
      <div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            />
            {errors.designation && (
              <p className="mt-1 text-xs text-destructive">{errors.designation.message}</p>
            )}
          </div>
          <div>
          ...
          <div>
            ...
            {errors.qualification && (
              <p className="mt-1 text-xs text-destructive">{errors.qualification.message}</p>
            )}
          </div>
          <div>
          ...
          <div className="sm:col-span-2">
            ...
            {errors.roleName && (
              <p className="mt-1 text-xs text-destructive">{errors.roleName.message}</p>
            )}
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="space-y-4">
          {fields.map((field, index) => (
            <div
              key={field.id}
              className="relative grid gap-4 rounded-xl border border-border bg-muted/20 p-4 sm:grid-cols-3"
            >
              <div>
