...
import type { ApiResponse, TeacherStudentsFilters, TeacherStudentsListResponse } from "@/types";
...
function attendanceRange(band: TeacherStudentsFilters["attendanceBand"]): {
  min?: number;
  max?: number;
} {
  switch (band) {
